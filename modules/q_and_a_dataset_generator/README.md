...
* Generate sample data with stock recomendation
    ```
    $ make data-w-stocks
    ```

* Generate data with optimized stocks for DSPY optimizer, given market dates
    ```
    $ make data-w-stocks-optimized --date-recommended YYYY-MM-DD --last-date YYYY-MM-DD
    ```
